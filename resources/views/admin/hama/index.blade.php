...
@section('title', 'Kelola Data Hama')
        ...
        <div class="px-6 px-lg-7 pt-8 border-bottom pb-5">
            <div class="d-flex align-items-center">
                ...
                <div class="hstack gap-2 ms-auto">
                    <a href="{{ route('admin.hama.create') }}" class="btn btn-sm btn-primary">
            ...
            <table class="table table-hover table-striped table-sm table-nowrap" id="dt-data">
                ...
                @forelse ($data as $item)
                    <tr>
                        ...
                        <td>{{ $item->kode }}</td>
                        <td class="text-end">
                            <a href="{{ route('admin.hama.show', $item) }}" class="btn btn-xs btn-success text-white">
                                <i class="bi bi-eye"></i>
                            </a>

                            <a href="{{ route('admin.hama.edit', $item) }}" class="btn btn-xs btn-warning text-white">
