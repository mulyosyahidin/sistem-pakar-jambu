            ...
            <div class="col-12">
                <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Edit Data Gejala</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a class="text-muted text-decoration-none"
                                               href="{{ route('gejala.show', $gejala) }}">{{ $gejala->kode }}</a>
                                        </li>
                ...
                <div class="card">
                    <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                        ...
                        <a href="{{ route('gejala.show', $gejala) }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="media_type" id="media-type"
                                        ...
                                        <option value="video" {{ old('media_type', $gejala->media_type) == 'video' ? 'selected' : '' }}>
                                            Video
                                        </option>
                                        <option value="image" {{ old('media_type', $gejala->media_type) == 'image' ? 'selected' : '' }}>
                                            Foto
                                        </option>
                                    </select>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-4 media-video {{ $gejala->media_type == 'video' ? '' : 'd-none' }}">
                                    ...
                                    <div class="mb-4 media-image {{ $gejala->media_type == 'image' ? '' : 'd-none' }}">
