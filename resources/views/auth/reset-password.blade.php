    ...
    <div
        ...
        <div class="w-md-50 mx-auto px-10 px-md-0 py-10">
            <div class="mb-10">
                ...
                <h1 class="ls-tight fw-bolder h3">Buat Password Baru</h1>
                <div class="mt-3 text-sm text-muted">
                    <span>Silahkan membuat password baru untuk akun Anda</span>
                </div>
            </div>
            <form action="{{ route('password.store') }}" method="POST">
                ...
                <div class="mb-5">
                    <div class="d-flex justify-content-between gap-2 mb-2 align-items-center">
                        <label class="form-label mb-0" for="password-confirmation">Konfirmasi Password Baru</label>
                    </div>
                    <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror"
                           id="password-confirmation" autocomplete="current-password" required>
                ...
                <div>
                    <input type="submit" value="Buat Password Baru" class="btn btn-dark w-100">
                </div>
            </form>
        </div>
    </div>
